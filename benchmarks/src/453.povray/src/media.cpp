 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.5/source/media.cpp $
 * $Revision: #34 $
 * $Change: 3010 $
...
#else
	spec_qsort((void *)(&s0[0]), (unsigned long)a, sizeof(DBL), compdoubles);
    spec_qsort((void *)(&s1[0]), (unsigned long)a, sizeof(DBL), compdoubles);
#endif /* SPEC_CPU */
    if (s0[0] > 0.0)
    {
      curr->lit = false;
