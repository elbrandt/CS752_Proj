 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.5/source/bbox.cpp $
 * $Revision: #24 $
 * $Change: 3010 $
...
static int CDECL compboxes (void *in_a, void *in_b);
...
long numberOfFiniteObjects, numberOfInfiniteObjects, numberOfLightSources; // GLOBAL VARIABLE
...
static int Axis = 0; // GLOBAL VARIABLE

/* Number of finite elements. */

static long maxfinitecount = 0; // GLOBAL VARIABLE

/* Priority queue used for frame level bouning box hierarchy. */

static PRIORITY_QUEUE *Frame_Queue; // GLOBAL VARIABLE

/* Top node of bounding hierarchy. */

BBOX_TREE *Root_Object; // GLOBAL VARIABLE
...
#else
  spec_qsort((void *)(&Finite[first]), (unsigned long)size, sizeof(BBOX_TREE *), compboxes);
#endif /* SPEC_CPU */
  /*
